...
Command:
```bash
wub assets export-finishing-bays   --spec shared/specs/profiles/hvlien/assets/export/finishing_bays_export.v1.yaml   --overwrite   --anchors-pack shared/specs/automation/anchors/<pack_id>
```
