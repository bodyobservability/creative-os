...
- Export racks → operator/packs/hvlien-defaults/ableton/racks/BASS_RACKS/
- Export performance set → operator/packs/hvlien-defaults/ableton/performance-sets/HVLIEN_BASS_PERFORMANCE_SET_v1.0.als
- Export finishing bays → operator/packs/hvlien-defaults/ableton/finishing-bays/*.als
