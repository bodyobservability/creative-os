...
## Command
```bash
wub assets export-serum-base   --out library/serum/HVLIEN_SERUM_BASE_v1.0.fxp   --anchors-pack shared/specs/automation/anchors/<pack_id>   --overwrite
```
...
## Plan used
This command runs:
`shared/specs/profiles/hvlien/assets/plans/serum_base_export.plan.v1.json`
...
- `wub midi list` not relevant here; this is UI automation + save dialog
