...
## Command (planned)
```bash
wub assets export-racks   --manifest shared/specs/profiles/hvlien/library/racks/rack_pack_manifest.v1.json   --out operator/packs/hvlien-defaults/ableton/racks/BASS_RACKS   --anchors-pack shared/specs/automation/anchors/<pack_id>   --overwrite ask   --interactive
```
...
- exported racks: `operator/packs/hvlien-defaults/ableton/racks/BASS_RACKS/*.adg`
