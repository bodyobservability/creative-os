...
## Usage
```bash
python3 kernel/tools/vrl_helper.py   --in shared/specs/profiles/hvlien/voice/runtime/vrl_triggers.v1.yaml   --out-dir out_vrl_helper   --channel 1   --group-name "WUB VRL"
```
