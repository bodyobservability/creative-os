...
- `racks_export.v1.yaml` is now expanded into a concrete list of expected `.adg` files using:
  - `shared/specs/profiles/hvlien/library/racks/rack_pack_manifest.v1.json` display names
  - output directory from `shared/specs/profiles/hvlien/assets/export/racks_export.v1.yaml`
