...
( printf "%s\0" README.md; find notes -type f -print0; find profiles -path "*/notes/*" -type f -print0; find docs -type f -print0; find profiles -path "*/docs/*" -type f -print0 ) | sort -z | xargs -0 shasum -a 256 > checksums/docs_sha256.txt
