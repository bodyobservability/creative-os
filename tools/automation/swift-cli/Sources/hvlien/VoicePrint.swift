...
```bash
hvlien doctor --modal-test detect --anchors-pack \(anchorsPack ?? "<anchors_pack>") --allow-ocr-fallback
hvlien apply --plan specs/voice/verify/verify_abi.plan.v1.json --anchors-pack \(anchorsPack ?? "<anchors_pack>")
```
