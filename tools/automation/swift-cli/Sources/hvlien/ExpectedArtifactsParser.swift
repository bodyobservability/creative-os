...
enum ExpectedArtifactsParser {
  /// Reads known export specs under specs/assets/export/ and produces expected artifact paths + thresholds.
  /// v1.8.2: expands racks_export expected artifacts using rack_pack_manifest display names.
  static func parseAll(defaultDir: String = "specs/assets/export",
                       rackManifestPath: String = "specs/library/racks/rack_pack_manifest.v1.json") throws -> [ExpectedArtifactV1] {
