...
struct Rack: ParsableCommand {
  ...
  struct Verify: AsyncParsableCommand {
    ...
    @Flag(name: .long, help: "Execute the generated plan via hvlien apply.")
  ...
  struct Recommend: ParsableCommand {
    ...
    @Option(name: .long, help: "Recommendations mapping JSON (optional).") var recommendations: String = "specs/library/recommendations/bass_music.v1.json"
