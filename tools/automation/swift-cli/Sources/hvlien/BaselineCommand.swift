...
struct Baseline: ParsableCommand {
  ...
  struct Set: ParsableCommand {
    ...
    @Option(name: .long, help: "Baselines root (default specs/sonic/baselines).") var root: String = "specs/sonic/baselines"
    @Option(name: .long, help: "Baseline index path (default specs/sonic/baselines/baseline_index.v1.json).") var index: String = "specs/sonic/baselines/baseline_index.v1.json"
  ...
  struct Get: ParsableCommand {
    ...
    @Option(name: .long) var profileId: String
    @Option(name: .long) var macro: String
    @Option(name: .long) var index: String = "specs/sonic/baselines/baseline_index.v1.json"
