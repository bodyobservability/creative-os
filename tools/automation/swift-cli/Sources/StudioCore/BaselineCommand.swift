...
struct Baseline: ParsableCommand {
  ...
  struct Set: ParsableCommand {
    ...
    @Option(name: .long, help: "Baselines root (default profiles/<active_profile>/specs/sonic/baselines).") var root: String = WubDefaults.profileSpecPath("sonic/baselines")
    @Option(name: .long, help: "Baseline index path (default profiles/<active_profile>/specs/sonic/baselines/baseline_index.v1.json).") var index: String = WubDefaults.profileSpecPath("sonic/baselines/baseline_index.v1.json")
