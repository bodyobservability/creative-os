...
struct VoiceArtifacts: Codable {
  ...
  enum CodingKeys: String, CodingKey {
    ...
    case sweeperReport = "sweeper_report"
...
struct VoiceReceiptV1: Codable {
  ...
  static func failed(runId: String, script: String, abi: String, card: String, verifyPlan: String,
                     sweeperReport: String?, applyReceipt: String?, applyTrace: String?, reasons: [String]) -> VoiceReceiptV1 {
    VoiceReceiptV1(schemaVersion: 1,
                   ...
                   artifacts: VoiceArtifacts(promptCard: card, verifyPlan: verifyPlan, sweeperReport: sweeperReport, applyReceipt: applyReceipt, applyTrace: applyTrace),
                   reasons: reasons)
  }
}
