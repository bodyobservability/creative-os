...
- Global Ableton prefs set per `specs/HVLIEN_AUDIO_SYSTEM_ABLETON_ARTIFACTS_v1.0-A.md`
...
specs/HVLIEN_AUDIO_SYSTEM_ABLETON_ARTIFACTS_v1.0-A.md
...
Follow `specs/HVLIEN_AUDIO_SYSTEM_ABLETON_ARTIFACTS_v1.0-A.md`, Section 3.
