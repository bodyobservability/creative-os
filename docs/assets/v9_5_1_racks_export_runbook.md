# v9.5.1 — Racks Export Automation Runbook
...
## Command (planned)
```bash
hvlien assets export-racks   --manifest specs/library/racks/rack_pack_manifest.v1.json   --out ableton/racks/BASS_RACKS_v1.0   --anchors-pack specs/automation/anchors/<pack_id>   --overwrite ask   --interactive
```
...
- exported racks: `ableton/racks/BASS_RACKS_v1.0/*.adg`
...
`hvlien assets export-racks --overwrite ask --interactive`
