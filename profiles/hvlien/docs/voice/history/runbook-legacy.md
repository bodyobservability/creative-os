...
Open:
- `profiles/hvlien/specs/voice/runtime/build_assets.voice_recipe.v1.yaml`
...
Run:
```bash
wub apply --plan profiles/hvlien/specs/voice/runtime/verify_assets.plan.v1.json --allow-cgevent
```
