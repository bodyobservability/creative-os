...
## Command
```bash
wub assets export-serum-base   --out library/serum/HVLIEN_SERUM_BASE_v1.0.fxp   --anchors-pack specs/automation/anchors/<pack_id>   --overwrite
```
...
## Plan used
This command runs:
`profiles/hvlien/specs/assets/plans/serum_base_export.plan.v1.json`
