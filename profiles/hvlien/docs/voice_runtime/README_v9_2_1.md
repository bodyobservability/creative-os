...
## Usage
```bash
python3 tools/v9_2_1_vrl_helper.py   --in profiles/hvlien/specs/voice_runtime/voice_runtime_triggers.v9.yaml   --out-dir out_v9_2_1   --channel 1   --group-name "WUB VRL v9"
```
