...
- v9.2 runtime bridge (Voice → KM → sendmidi → WUB_VOICE)
...
Open:
- `profiles/hvlien/specs/voice_runtime/v9_3_1_build_assets.voice_recipe.yaml`
...
Run:
```bash
wub apply --plan profiles/hvlien/specs/voice_runtime/v9_3_1_verify_assets.plan.v1.json --allow-cgevent
```
