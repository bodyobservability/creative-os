...
A0 (safe‑mode manual inventory):
  .build/release/wub a0 --spec shared/specs/profiles/hvlien/automation/examples/HVLIEN_RECORDING_BAY_v1.yaml --interactive
...
OpenCV build guide:
  kernel/cli/docs/OPENCV_BUILD.md
...
Drift check/plan/fix:
  wub drift check --anchors-pack-hint shared/specs/automation/anchors/<pack_id>
  wub drift plan  --anchors-pack-hint shared/specs/automation/anchors/<pack_id>
  wub drift fix   --anchors-pack-hint shared/specs/automation/anchors/<pack_id> --dry-run
...
Rack install/verify:
  wub rack install --manifest shared/specs/profiles/hvlien/library/racks/rack_pack_manifest.v1.json --macro-region rack.macros --anchors-pack <pack>
  wub rack verify  --manifest shared/specs/profiles/hvlien/library/racks/rack_pack_manifest.v1.json --macro-region rack.macros --anchors-pack <pack>
...
Operator shell:
  wub ui --anchors-pack shared/specs/automation/anchors/<pack_id>

Asset export:
  wub assets export-all --anchors-pack shared/specs/automation/anchors/<pack_id> --overwrite
